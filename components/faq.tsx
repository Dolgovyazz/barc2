...
const items = [
  {
    ...
    a: 'Да. Я ориентируюсь в том числе на запросы подписчиков. Пиши в чат (тариф Бармен) или в личные сообщения — если тема интересная и вписывается в формат, я возьму её в работу.',
  },
  {
